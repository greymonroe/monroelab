  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        | Resource | Description | Link |
        |----------|-------------|------|
        | Arabidopsis Information Resource (TAIR) | The primary database for Arabidopsis thaliana genomics | [TAIR](https://www.arabidopsis.org/) |
        | Phytozome | Plant comparative genomics portal (JGI) | [Phytozome](https://phytozome-next.jgi.doe.gov/) |
        | NCBI SRA | Sequencing data repository | [SRA](https://www.ncbi.nlm.nih.gov/sra) |
        | Google Scholar - Monroe Lab | Complete publication list | [Scholar](https://scholar.google.com/citations?user=WcgLCEIAAAAJ&hl=en) |
    design:
      columns: '1'
---
