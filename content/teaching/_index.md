...
sections:
  - block: markdown
    content:
      title: Teaching
      text: |
        Grey Monroe teaches in the [Department of Plant Sciences](https://www.plantsciences.ucdavis.edu/) at UC Davis.

        ---

        ## Fall Quarter

        ### PLS 152 — Plant Genetics
        ...
        *Every other year*
        ...
        A graduate seminar on plant genetics offered through the [Integrative Genetics and Genomics graduate group](https://igg.ucdavis.edu/).

        ---

        ## Spring Quarter

        ### Plant Biology Graduate Group Seminar Series
        *Seminar series lead*
